  ...
  function lex(text) {
    ...
    for (var i = 0, l = text.length; i < l; i++) {
      if (text[i] === OPEN_BRACE) {
        ...
        var _p = n;
        var previous = _p.rules[_p.rules.length - 1];
        n = {
          start: i + 1,
          parent: _p,
          previous: previous
    ...
    _transformRuleCss: function _transformRuleCss(rule, transformer, scope, hostScope) {
      ...
      if (!isKeyframesSelector(rule)) {
        for (var i = 0, l = p$.length, _p2; i < l && (_p2 = p$[i]); i++) {
          p$[i] = transformer.call(this, _p2, scope, hostScope);
        }
      }
  ...
  */
  ...
  var StyleProperties = {
    ...
    valueForProperties: function valueForProperties(property, props) {
      ...
      for (var i = 0, _p3, m; i < parts.length; i++) {
        if (_p3 = parts[i]) {
          this.rx.MIXIN_MATCH.lastIndex = 0;
          m = this.rx.MIXIN_MATCH.exec(_p3);
          if (m) {
            _p3 = this.valueForProperty(props[m[1]], props);
          } else {
            var colon = _p3.indexOf(':');
            if (colon !== -1) {
              var pp = _p3.substring(colon);
              pp = pp.trim();
              pp = this.valueForProperty(pp, props) || pp;
              _p3 = _p3.substring(0, colon) + pp;
            }
          }
          parts[i] = _p3 && _p3.lastIndexOf(';') === _p3.length - 1 ?
          // strip trailing ;
          _p3.slice(0, -1) : _p3 || '';
        }
      }
    ...
    _scopeSelector: function _scopeSelector(rule, hostRx, hostSelector, scopeId) {
      ...
      for (var i = 0, l = parts.length, _p4; i < l && (_p4 = parts[i]); i++) {
        parts[i] = _p4.match(hostRx) ? _p4.replace(hostSelector, scope) : scope + ' ' + _p4;
      }
    ...
    _createClass(ApplyShim, [{
      ...
      value: function _atApplyToCssProperties(mixinName, fallbacks) {
        ...
        if (mixinEntry) {
          ...
          var _p5 = void 0,
              parts = void 0,
              f = void 0;
          for (_p5 in mixinEntry.properties) {
            f = fallbacks && fallbacks[_p5];
            parts = [_p5, ': var(', mixinName, MIXIN_VAR_SEP, _p5];
            if (f) {
              parts.push(',', f);
            }
            parts.push(')');
      ...
      value: function _cssTextToMap(text) {
        ...
        var property = void 0,
            value = void 0;
        var out = {};
        for (var i = 0, _p6, sp; i < props.length; i++) {
          _p6 = props[i];
          if (_p6) {
            sp = _p6.split(':');
  ...
  var ShadyCSS = {
    ...
    _updateNativeProperties: function _updateNativeProperties(element, properties) {
      ...
      for (var _p8 in properties) {
        ...
        if (_p8 === null) {
          element.style.removeProperty(_p8);
        } else {
          element.style.setProperty(_p8, properties[_p8]);
        }
      }
    },
    ...
    _transformCustomStyleForDocument: function _transformCustomStyleForDocument(style) {
      ...
      forEachRule(ast, function (rule) {
        ...
        if (_this6.nativeCss && !_this6.nativeCssApply) {
  ...
  */
  ...
  var CustomStyle = function (_HTMLElement) {
        ...
        for (var i = 0; i < customStyles.length; i++) {
          ...
          if (!c._style) {
            ...
            if (style.__appliedElement) {
              for (var _i2 = 0; _i2 < style.attributes.length; _i2++) {
                var attr = style.attributes[_i2];
    ...
    function CustomStyle() {
      ...
      var _this7 = _possibleConstructorReturn(this, (CustomStyle.__proto__ || Object.getPrototypeOf(CustomStyle)).call(this));

      customStyles.push(_this7);
